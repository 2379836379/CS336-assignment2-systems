...
from cs336_systems.distributed import DDP, FSDP, get_sharded_optimizer as build_sharded_optimizer
from cs336_systems.flash_attention import FlashAttentionFunction, TritonFlashAttentionFunction
...
def get_sharded_optimizer(params, optimizer_cls: type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    return build_sharded_optimizer(params, optimizer_cls, **kwargs)
